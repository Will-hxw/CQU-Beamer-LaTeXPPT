...
%%% 字体设置 - 在文档类之后立即设置字体 %%%
% 注意：这些设置需要使用XeLaTeX编译

%%% 基础包 Basic Packages %%%
\usepackage{auto-pst-pdf}
\usepackage{fontspec}    % XeLaTeX下字体设置所必需
\usepackage{ctex}       % 中文支持包
\usepackage{hyperref}   % 提供超链接功能

%%% 英文字体设置 为 Times New Roman %%%
\setmainfont{Times New Roman}
\setsansfont{Times New Roman}
\newfontfamily\wenkai{LXGWWenKai-Medium}
...
%%% 导航栏与标题页字体 - LXGW WenKai %%%
\setbeamerfont{navigation bar}{family=\wenkai}
\setbeamerfont{title}{family=\wenkai}
\setbeamerfont{author}{family=\wenkai}
\setbeamerfont{institute}{family=\wenkai}
\setbeamerfont{subtitle}{family=\wenkai}
